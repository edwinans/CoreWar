...
public class Instruction {
	...
	public Instruction(String code) throws CoreException {
		...
		if(tokens.length<2 || tokens.length>3)
			throw new CoreException("le nombre de parametre est incorrect");
	...
	/*format int gauche a droite:
	 * 4 premier bit: opCode
	 * 2 prochain : mode Afield
	 * 12 prochain: Afield
	 * 2 porchain: mode Bfield
	 * 12 prochain" Bfield
	 */
	...
	public static int redCodeToInt(String redCode) throws CoreException {
		...
		switch(redCode) {
			...
			case "SNE":
				...
				break;
			default:
				throw new CoreException("operation illegal!");
		}
		return op;
	}
